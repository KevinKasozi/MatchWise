    ...
    <div className="w-full p-4 space-y-8">
      ...
      <Tabs.Root defaultValue="users" className="w-full">
        <Tabs.List className="flex gap-2 mb-4">
          <Tabs.Trigger
            value="users"
            className="px-4 py-2 rounded-lg font-semibold text-primary bg-white/70 shadow border border-primary-light data-[state=active]:bg-primary data-[state=active]:text-white transition"
          >
            Users
          </Tabs.Trigger>
          <Tabs.Trigger
                    ...
                    <tr key={u.id} className="border-b last:border-0">
                      ...
                      <td className="p-2 flex gap-2">
                        <Dialog.Root
                          ...
                          onOpenChange={(open) =>
                            setOpenUserId(open ? u.id : null)
                          }
                        >
                          <Dialog.Trigger asChild>
                            <button className="px-2 py-1 rounded bg-primary text-white text-xs font-bold hover:bg-primary-dark">
                              Edit
                            </button>
                          </Dialog.Trigger>
                            ...
                            <div className="bg-white rounded-xl shadow-lg p-6 w-80 border border-primary-light">
                              ...
                              <div className="flex justify-end gap-2">
                                <Dialog.Close asChild>
                                  <button className="px-3 py-1 rounded bg-primary text-white font-semibold">
                                    Save
                                  </button>
                                </Dialog.Close>
                                <Dialog.Close asChild>
                                  <button className="px-3 py-1 rounded bg-slate-200 text-slate-700 font-semibold">
                                    Cancel
                                  </button>
                                </Dialog.Close>
                              </div>
                        ...
                        <button className="px-2 py-1 rounded bg-error text-white text-xs font-bold hover:bg-error-dark">
                          Delete
                        </button>
                      </td>
                    </tr>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white/60 backdrop-blur-md shadow-glass rounded-2xl p-6 border border-primary-light flex flex-col items-center">
              ...
              <div className="text-slate-600 mb-4">
                Manage all football teams in the database.
              </div>
            ...
            <div className="bg-white/60 backdrop-blur-md shadow-glass rounded-2xl p-6 border border-primary-light flex flex-col items-center">
              ...
              <div className="text-slate-600 mb-4">
                Manage all players and their data.
              </div>
              <button className="px-4 py-2 rounded bg-primary text-white font-semibold">
                Manage Players
              </button>
            ...
            <div className="bg-white/60 backdrop-blur-md shadow-glass rounded-2xl p-6 border border-primary-light flex flex-col items-center">
              ...
              <div className="text-slate-600 mb-4">
                Manage fixtures, results, and match data.
              </div>
              <button className="px-4 py-2 rounded bg-primary text-white font-semibold">
                Manage Matches
              </button>
          ...
          <div className="bg-white/60 backdrop-blur-md shadow-glass rounded-2xl p-6 border border-primary-light w-full">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <input
                  className="w-full border rounded p-2"
                  defaultValue="support@matchwise.com"
                />
              </div>
              <button
                type="submit"
                className="px-4 py-2 rounded bg-primary text-white font-semibold mt-2"
              >
                Save Settings
              </button>
            </form>
