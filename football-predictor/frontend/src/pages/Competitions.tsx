      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {filtered.map((c) => (
          ...
          >
            ...
            <div className="text-lg font-bold mb-1" style={{ color: c.color }}>{c.name}</div>
            <div className="text-slate-700 text-sm mb-2">{c.country}</div>
            <div className="flex gap-2">
              <a href="#" className="text-xs text-primary hover:underline">Fixtures</a>
              <a href="#" className="text-xs text-primary hover:underline">Results</a>
              <a href="#" className="text-xs text-primary hover:underline">Standings</a>
            </div>
          </div>
        ))}
      </div>
