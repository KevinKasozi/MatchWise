...
const favoritePlayers = [
  {
    name: "Erling Haaland",
    photo:
      "https://upload.wikimedia.org/wikipedia/commons/5/5e/Erling_Haaland_2023.jpg",
    team: "Man City",
    goals: 28,
    assists: 7,
  },
  {
    name: "Bukayo Saka",
    photo:
      "https://upload.wikimedia.org/wikipedia/commons/8/8e/Bukayo_Saka_2022.jpg",
    team: "Arsenal",
    goals: 15,
    assists: 10,
  },
        ...
        <Tabs.Content value="teams">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {favoriteTeams.map((team) => (
              <div
                key={team.name}
                className="bg-white/90 rounded-2xl shadow p-6 border border-slate-100 flex items-center gap-4 hover:shadow-lg transition-shadow"
              >
                ...
                <div>
                  ...
                  <div className="text-xs mt-1 text-slate-500">
                    Pos: <span className="font-semibold">{team.position}</span>{" "}
                    | Pts: <span className="font-semibold">{team.points}</span>
                  </div>
                </div>
              </div>
            ))}
            ...
            {favoriteCompetitions.map((comp) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs mt-1 text-slate-500">
                    Teams: <span className="font-semibold">{comp.teams}</span>
                  </div>
                </div>
              </div>
            ))}
